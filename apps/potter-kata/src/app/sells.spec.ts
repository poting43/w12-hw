...
describe('Sells', () => {
  ...
  test('Sell 2 for the first episode, 2 for the second episode, 2 for the third episode, 1 for the fourth episode, 1 for the fifth episode', () => {
    const sells = new Sells();
    sells.buy(1,2);
    sells.buy(2,2);
    sells.buy(3,2);
